...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Transactional
    @Override //리뷰 조회
    public List<CommentDTO> getReviews(Long boardId) {
...
//            reviewResponseDTO.setRootNum(review.getRootNum());
    ...
    @Override
    public List<ReplyDTO> getReplies(Long rootNumId) {
        List<ReplyDTO> replies = reviewRepository.findReplyByRootNum(rootNumId);
